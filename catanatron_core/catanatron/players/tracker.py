    ...
    def update_opponent_resources(self, state, action):
        ...
        try:
            ...
            if action.action_type == ActionType.ROLL:
                ...
                print(f'offer to give of player {action.color} has:', trade_offer, ', len: ', givingcost)
            ...
            print('-----------------------------------------------')    
            print(f"action was: {action.action_type} by {action.color}")
            ...
            for i in state.players:
                print('----------------------')
                print(f"I assume Player {i.color} has {self.assumed_resources[i.color]}")
                print(f"Player {i.color} actually has: ")
                print(get_player_freqdeck(state, i.color))
            print('-----------------------------------------------')
        except Exception as e:
            print("Exception: ", e)
            pdb.set_trace()
